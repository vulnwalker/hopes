 ...
 * [refAccount.OnListFragmentInteractionListener] interface.
 */
...
//    val databaseHelper = KotlinHelper(context)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = dataAccountAdapter(dataAccount.ITEMS, listener)
            }
        }
        return view
    }
...
//        }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: dataAccount.DummyItem){
